...
export const mockUploads: UploadArtifact[] = [
  {
    ...
    extracted: {
      ...
      cutoffs: [
        { grade: "A",  minPercent: 93, confidence: 0.97 },
        { grade: "A-", minPercent: 90, confidence: 0.97 },
        { grade: "B+", minPercent: 87, confidence: 0.97 },
        { grade: "B",  minPercent: 83, confidence: 0.97 },
        { grade: "B-", minPercent: 80, confidence: 0.97 },
      ],
      attendancePolicy: {
